            ...
            <div class="CadastroFormSection" id="cadastroFormSection" hidden>
                ...
                <form class="CadastroForm" id="cadastroForm">
                    <div class="CadastroStep" data-passo="1">
                        <!-- Nome deixou de ser digitado aqui — vem da conta Google (ver
                             passo 4 "Publicando como" e formatarPrestador.js no backend). -->
                        <label class="CadastroField">
                            <span class="CadastroLabel">Categoria / serviço</span>
                            <input type="text" name="categoria" class="CadastroInput" placeholder="Ex: Eletricista, Mecânico..." list="cadastroCategoriasList" autocomplete="off" required>
                            <!-- Preenchida via JS com as categorias já cadastradas (ver
                                 carregarCategoriasExistentes em script.js) — datalist só
                                 SUGERE, nunca restringe o que a pessoa pode digitar. -->
                            <datalist id="cadastroCategoriasList"></datalist>
                        </label>
                    ...
                    <div class="CadastroStep" data-passo="4" hidden>
                        <div class="FotosPrestadorSection" style="margin-top:0; padding-top:0; border-top:none;">
                            <div class="CadastroMeusTitle">Publicando como</div>
                            <div class="FotosPrestadorAvatarRow">
                                <!-- Nome e foto não são mais escolhidos aqui — vêm ao vivo da
                                     conta Google que fez o cadastro (ver formatarPrestador.js
                                     no backend e cadastroContaAvatarEl/cadastroContaNomeEl em
                                     script.js, que preenchem isto com perfilUsuarioCache). -->
                                <div class="ProfileAvatarBig" id="cadastroContaAvatar" style="position:relative; overflow:hidden; flex-shrink:0;"></div>
                                <div class="CadastroHint" style="margin:0;">
                                    <strong id="cadastroContaNome" style="color:var(--ink-text); display:block; margin-bottom:2px;"></strong>
                                    Esse é o nome e a foto que vão aparecer pra quem visitar este perfil — vêm direto da sua conta Google, não dá pra trocar por aqui.
                                </div>
                            </div>
                        </div>
                ...
                <div class="CadastroSuccess" id="cadastroSuccess" hidden>
                    ...
                    <button type="button" class="CadastroSubmit" id="cadastroSuccessVerPerfilBtn" style="margin-top:16px;">Ver perfil</button>
                </div>
            </div>
